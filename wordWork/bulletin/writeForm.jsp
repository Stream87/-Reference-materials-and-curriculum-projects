...
<body>
  ...
  <div class="container">
    <h1 class="display-3" align="center">WriteForm</h1>
		...
		제목  &nbsp; &nbsp; <input class="form-control mr-sm-2" type="text" name="title" size="20" >
		작성자  <input class="form-control mr-sm-2" type="text" name="writerName"  required="required"/>
		글암호  <input class="form-control mr-sm-2" type="password" name="password" onsubmit="return check()" required="required"/>
		<textarea class="form-control mr-sm-2" rows="5" cols="40" name="content" placeholder="내용을 기입하세요"> </textarea>
	...
	<div>
		...
		<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h1 class="display-3" align="center">글쓰기 입력란 입니다</h1>
</div>
</div>
