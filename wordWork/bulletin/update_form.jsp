...
<body>
  ...
  <div class="container">
    <h1 class="display-3" align="center">UpdateForm</h1>
	...
	<div class="write-form" >
		...
		제목   &nbsp;&nbsp;&nbsp;<input class="form-control mr-sm-2" type="text" name="title" size="20" value="<%=article.getTitle() %>" onsubmit="return check()" required="required">
		...
		글 내용 <textarea class="form-control mr-sm-2" rows="5" cols="40" name="content" placeholder="내용을 기입하세요"> <%=article.getContent() %> </textarea>
			...
			<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h1 class="display-3" align="center">글 수정 기립란 입니다</h1>
</div>
</div>
</body>
</html>